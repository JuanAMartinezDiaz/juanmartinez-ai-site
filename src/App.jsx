...
import DecisionXRay2 from './DecisionXRay2';
...
export default function JuanProfessionalLandingPage() {
  ...
  if (typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('view') === 'decision-xray') {
    return <DecisionXRay2 />;
  }
